...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.pushButton_4.setGeometry(QtCore.QRect(180, 80, 121, 41))
        self.pushButton_4.setObjectName("pushButton_4")
        self.pushButton_3 = QtWidgets.QPushButton(self.centralwidget)
        self.pushButton_3.setGeometry(QtCore.QRect(180, 130, 121, 41))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pushButton.setText(_translate("MainWindow", "打开游戏.ycp 目录"))
        self.pushButton_2.setText(_translate("MainWindow", "打开.yland 目录"))
        self.pushButton_4.setText(_translate("MainWindow", "打开组件.ycp目录"))
        self.pushButton_3.setText(_translate("MainWindow", "打开游戏日志"))
